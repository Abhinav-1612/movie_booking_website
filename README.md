...
⚙️ Local Installation GuideFollow these steps to run the project on your laptop.1. PrerequisitesNode.js installed.MySQL Server (Workbench) installed and running.2. Clone the RepositoryBashgit clone https://github.com/YOUR_USERNAME/movie-booking.git
cd movie-booking
